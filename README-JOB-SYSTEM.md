...
This document explains how the DAI Miner Network intelligently routes work using a global job mempool + latency awareness.
...
- Ability for the app layer (iamai.kg) to tag jobs with origin region
- Staking-weighted reputation affecting job eligibility

This system is one of the key innovations that makes running a DAI miner economically rational and fair.
