...
id: code_audit
version: 1.0.0
description: Analyzes proposed skill code for safety and alignment with its manifest description. Enabled by default on all nodes. Deploy fee (1 DAI) goes to the miner who runs this job.
allowedEndpoints:
  - '*'
triggers:
  - audit skill
