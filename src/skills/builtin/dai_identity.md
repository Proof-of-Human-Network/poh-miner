...
id: dai_identity
version: 1.0.0
description: Full decentralized-artificial-intelligence identity scan using on-chain signals and AI brain
allowedEndpoints:
  - '*'
triggers:
  - human
...
Full decentralized-artificial-intelligence identity verification for any wallet address. Runs 100+ on-chain signals (EVM history, Solana activity, identity protocols, social presence) and produces an AI verdict.
