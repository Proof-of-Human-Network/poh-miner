...
2. Chainlink generates random number off-chain with a V

_(reference truncated — see https://github.com/austintgriffith/ethskills/tree/main/concepts for the full document)_
