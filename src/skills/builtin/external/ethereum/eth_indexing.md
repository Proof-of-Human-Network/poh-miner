...
const client = createPublicClient({ chain: mainnet, trans

_(reference truncated — see https://github.com/austintgriffith/ethskills/tree/main/indexing for the full document)_

Source: https://github.com/austintgriffith/ethskills/tree/main/indexing
