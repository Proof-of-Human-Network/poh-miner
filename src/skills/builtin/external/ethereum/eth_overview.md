...
**Building a dApp?** Fetch [`eth_ship` skill](https://ethskills.com/`eth_ship` skill) first. It routes you through all other skills phase by phase — from architecture planning to production deployment.
...
### [Ship](https://ethskills.com/`eth_ship` skill) — Start here
...
### [Why Ethereum](https://ethskills.com/`eth_why` skill)
...
### [Protocol](https://ethskills.com/`eth_protocol` skill)
...
### [Gas & Costs](https://ethskills.com/`eth_gas` skill)
...
### [Wallets](https://ethskills.com/`eth_wallets` skill)
...
### [Layer 2s](https://ethskills.com/`eth_l2s` skill)
...
### [Standards](https://ethskills.com/`eth_standards` skill)
...
### [Tools](https://ethskills.com/`eth_tools` skill)
...
### [Building Blocks (DeFi)](https://ethskills.com/`eth_building_blocks` skill)
...
### [Orchestration](https://ethskills.com/`eth_orchestration` skill)
...
### [Contract Addresses](https://ethskills.com/`eth_addresses` skill)
...
### [Concepts](https://ethskills.com/`eth_concepts` skill)
...
### [Security](https://ethskills.com/`eth_security` skill)
...
### [Audit](https://ethskills.com/`eth_audit` skill)
...
### [Noir (ZK Privacy)](https://ethskills.com/`eth_noir` skill)
...
### [Testing](https://ethskills.com/`eth_testing` skill)
...
### [Indexing](https://ethskills.com/`eth_indexing` skill)
