...
let cpi_ctx = CpiContext::new(
    ctx.accounts.inco_li

_(reference truncated — see https://github.com/sendaifun/skills/tree/main/skills/inco for the full document)_

Source: https://github.com/sendaifun/skills/tree/main/skills/inco
