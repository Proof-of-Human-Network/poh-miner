...
//
// `name` / `place` are the country and landmark in the page language. `{country}`
// and `{landmark}` fill from those so Arabic pages say مصر, not Egypt.
//
...
export const COUNTRIES = [
  {
    slug: 'kgs', cc: 'kg', lang: 'ky', country: 'Kyrgyzstan', name: 'Кыргызстан', coin: 'KGST',
    landmark: 'Issyk-Kul & the Tian Shan', place: 'Ысык-Көл жана Теңир-Тоо', scene: 'lakeMountains',
    power: 0.035, fx: 87,
  ...
  {
    slug: 'etb', cc: 'et', lang: 'am', country: 'Ethiopia', name: 'ኢትዮጵያ', coin: 'aiETB',
    landmark: 'The Simien Mountains', place: 'የሰሜን ተራሮች', scene: 'escarpment',
    power: 0.02, fx: 128,
  ...
  {
    slug: 'btn', cc: 'bt', lang: 'dz', country: 'Bhutan', name: 'འབྲུག', coin: 'aiBTN',
    landmark: "Paro Taktsang — the Tiger's Nest", place: 'སྤ་རོ་སྟག་ཚང་།', scene: 'cliffMonastery',
    power: 0.03, fx: 84,
  ...
  {
    slug: 'ves', cc: 've', lang: 'es', country: 'Venezuela', name: 'Venezuela', coin: 'aiVES',
    landmark: 'Salto Ángel y los tepuyes', place: 'Salto Ángel y los tepuyes', scene: 'waterfallTepui',
    power: 0.01, fx: 250,
  ...
  {
    slug: 'pyg', cc: 'py', lang: 'es', country: 'Paraguay', name: 'Paraguay', coin: 'aiPYG',
    landmark: 'La represa de Itaipú', place: 'La represa de Itaipú', scene: 'dam',
    power: 0.05, fx: 7300,
  ...
  {
    slug: 'bdt', cc: 'bd', lang: 'bn', country: 'Bangladesh', name: 'বাংলাদেশ', coin: 'aiBDT',
    landmark: 'সুন্দরবন — the Sundarbans delta', place: 'সুন্দরবন', scene: 'delta',
    power: 0.08, fx: 122,
  ...
  {
    slug: 'pkr', cc: 'pk', lang: 'ur', country: 'Pakistan', name: 'پاکستان', coin: 'aiPKR',
    landmark: 'بادشاہی مسجد — the Badshahi Mosque', place: 'بادشاہی مسجد', scene: 'mosque',
    power: 0.09, fx: 282,
  ...
  {
    slug: 'egp', cc: 'eg', lang: 'ar', country: 'Egypt', name: 'مصر', coin: 'aiEGP',
    landmark: 'أهرامات الجيزة — the Pyramids of Giza', place: 'أهرامات الجيزة', scene: 'pyramids',
    power: 0.05, fx: 48,
  ...
  {
    slug: 'iqd', cc: 'iq', lang: 'ar', country: 'Iraq', name: 'العراق', coin: 'aiIQD',
    landmark: 'ملوية سامراء — the Malwiya of Samarra', place: 'ملوية سامراء', scene: 'spiralMinaret',
    power: 0.03, fx: 1310,
  ...
  {
    slug: 'aoa', cc: 'ao', lang: 'pt', country: 'Angola', name: 'Angola', coin: 'aiAOA',
    landmark: 'As Quedas de Kalandula', place: 'Quedas de Kalandula', scene: 'fallsWide',
    power: 0.02, fx: 915,
  ...
  {
    slug: 'cup', cc: 'cu', lang: 'es', country: 'Cuba', name: 'Cuba', coin: 'aiCUP',
    landmark: 'El Capitolio y el Malecón', place: 'El Capitolio y el Malecón', scene: 'havana',
    power: 0.03, fx: 400,
  ...
  {
    slug: 'lyd', cc: 'ly', lang: 'ar', country: 'Libya', name: 'ليبيا', coin: 'aiLYD',
    landmark: 'لبدة الكبرى — Leptis Magna', place: 'لبدة الكبرى', scene: 'ruins',
    power: 0.01, fx: 5.5,
  ...
  {
    slug: 'sdg', cc: 'sd', lang: 'ar', country: 'Sudan', name: 'السودان', coin: 'aiSDG',
    landmark: 'أهرامات مروي — the Pyramids of Meroë', place: 'أهرامات مروي', scene: 'meroe',
    power: 0.02, fx: 2600,
  ...
  {
    slug: 'irr', cc: 'ir', lang: 'fa', country: 'Iran', name: 'ایران', coin: 'aiIRR',
    landmark: 'تخت جمشید — Persepolis', place: 'تخت جمشید', scene: 'persepolis',
