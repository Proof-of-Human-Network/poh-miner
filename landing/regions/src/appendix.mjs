...
${page(`
  ...
  <p>Это приложение описывает опцию, при которой резерв первой партии формируется <strong>не с баланса эмитента</strong>, а за счёт капитала, привлечённого нотами облигационного типа по частному размещению среди международных инвесторов. Это финансирование резерва, а не звено платёжного коридора. Опция дополняет, а не заменяет базовую схему: механика партий и распределение операционной выручки 80/20 из меморандума остаются неизменными — 80% это купон на резерв, а не его высвобождение.</p>
...
${page(`
  ...
  <h4>4. Обслуживание нот</h4><p class="small">Маржа от продаж вычислений плюс доход на самом резерве (казначейские инструменты, депозиты) покрывают купон. Тело нот гасится по мере погашения монет и высвобождения резерва.</p>
